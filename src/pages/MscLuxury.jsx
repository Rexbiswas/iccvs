                ...
                <div className="max-w-7xl mx-auto space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1">
                        {[
                            ...
                            { title: "Customer Experience", desc: "Design bespoke and highly personalized service journeys for UHNW clientele.", img: "https://images.unsplash.com/photo-1556740734-754f159aee39?auto=format&fit=crop&q=80&w=800" },
