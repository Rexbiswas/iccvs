            ...
            <section className="relative h-[70vh] md:h-[85vh] flex items-center justify-center pt-20 md:pt-32 text-center px-6 overflow-hidden bg-slate-900">
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    <motion.div
                        ...
                        className="space-y-6 pt-20 md:pt-32"
                    >
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                            {[
                                { title: "Brand Engineering", desc: "Scientific approach to design thinking and corporate identity construction." },
                                { title: "Motion Grammar", desc: "Bringing static concepts to life through cinematic animation and digital rhythm." },
                                { title: "Interface Logic", desc: "Mastering the architecture of user experience and responsive digital design." }
                            ].map((outcome, i) => (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 h-auto md:h-[600px]">
                        <div className="col-span-1 md:col-span-7 h-[300px] md:h-full rounded-2xl overflow-hidden shadow-2xl">
                            <img src="https://images.unsplash.com/photo-1626785774573-4b799315345d?auto=format&fit=crop&q=80&w=600" className="w-full h-full object-cover" alt="Graphic Design" />
                        </div>
                        <div className="col-span-1 md:col-span-5 grid grid-cols-2 md:col-span-1 gap-4 h-[200px] md:h-full">
                                                    ...
                                                    {Array.isArray(items) ? (
                                                        items.map((item, i) => (
                                                            ...
                                                            >
                                                                ...
                                                                <span className="text-slate-600 font-black text-clamp-sm uppercase tracking-tight group-hover/item:text-slate-900 transition-colors">
                                                                    {item}
                                                                </span>
                                                            </motion.div>
                                                        ))
